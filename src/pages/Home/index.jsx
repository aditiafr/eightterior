...
const Home = () => {
  ...
  return (
    <>
      <section className="h-72 md:min-h-screen bg-cover bg-center flex flex-col justify-center items-center gap-4" style={{ backgroundImage: "url('assets/images/home/bg-img-1.png')" }}>
        <div className="flex flex-col items-center justify-center gap-2 md:gap-8">
          <h1 className="text-4xl md:text-8xl text-primary-500 font-bold">We Inspire</h1>
          <h1 className="text-4xl md:text-8xl text-second-500 font-bold">Your Style</h1>
        </div>
      </section>
      ...
      <section className="w-full md:max-w-[1120px] flex flex-wrap items-center justify-between px-8 md:mx-auto my-14 md:my-24">
        <div className="flex justify-evenly items-center w-full gap-8 md:gap-32">
          <div className="relative flex justify-center items-center">
            <img src="assets/images/home/img-2.png" alt="img-2" className="w-32 md:w-96 h-40 md:h-[460px] absolute top-2 md:top-5 left-2 md:left-5 z-10" />
          ...
          <div className="flex flex-col md:gap-2 w-full">
            <h2 className="text-primary-500 font-bold text-2xl md:text-[64px]">Eight<span className="text-second-500">terior</span></h2>
            <p className="text-[8px] md:text-2xl mt-1 md:mt-5 font-light">PT. Delapan Mitra Interior</p>
        ...
        <div className="w-full flex flex-col md:flex-row justify-between items-center mt-16 md:mt-24 gap-8 md:gap-0">
          <div className="flex flex-col items-center md:items-start md:gap-4 w-1/2">
            <h2 className="text-2xl md:text-[64px] text-primary-500 font-bold">What we do</h2>
            <p className="text-[8px] md:text-2xl md:mt-4 font-light">We can help realize your dream</p>
            <Link to={`/about`}>
          ...
          <div className="grid grid-cols-2 w-full md:w-2/3 justify-between gap-x-9 md:gap-x-20 gap-y-6 md:gap-y-12">
            {pictHome.map((item, index) => (
              <div key={index} className="flex flex-col items-center gap-2">
                <img src={item.imgUrl} alt={item.name} className="w-24 md:w-48" />
      ...
      <section className="md:h-screen h-64 w-full">
        ...
        >
          <div className="relative md:min-h-screen h-full bg-cover bg-center flex flex-col gap-4 overflow-hidden" style={{ backgroundImage: "url('/assets/images/home/carousel/img-1.png')" }}>
          ...
          <div className="relative md:min-h-screen h-full bg-cover bg-center flex flex-col gap-4 overflow-hidden" style={{ backgroundImage: "url('/assets/images/home/carousel/img-3.png')" }}>
            <div className="absolute inset-0 bg-black opacity-50 z-0"></div>
            <div className="relative flex flex-col justify-center h-full md:mx-52 text-white gap-1 md:gap-4 mx-16">
              ...
              <h1 className="text-xl md:text-5xl font-bold">PT. PUNDI MITRA MANDIRI</h1>
              <div className="relative">
          ...
          <div className="relative md:min-h-screen h-full bg-cover bg-center flex flex-col gap-4 overflow-hidden" style={{ backgroundImage: "url('/assets/images/home/carousel/img-4.png')" }}>
            <div className="absolute inset-0 bg-black opacity-50 z-0"></div>
            <div className="relative flex flex-col justify-center h-full md:mx-52 text-white gap-1 md:gap-4 mx-16">
              <h3 className="text-sm md:text-[32px]">RECENT PROJECT</h3>
              <h1 className="text-xl md:text-5xl font-bold">RUMAH IBU ANDIRA</h1>
              <div className="relative">
      ...
      <section className="w-full my-12 md:my-20" id="testimoni">
        <div className="flex items-center justify-between w-full">
          <img src="assets/images/home/img-3.png" alt="..." className="relative w-1/2" />
          <div ref={containerRef} className={`absolute flex items-center gap-2 md:gap-4 p-6 w-full pl-[100px] md:pl-[600px] overflow-x-auto no-scrollbar ${isDragging ? 'cursor-grabbing' : 'cursor-grab'}`} onMouseDown={handleMouseDown} onMouseMove={handleMouseMove} onMouseUp={handleMouseUp} onMouseLeave={handleMouseUp}>
            <div className="bg-white w-full p-4 h-24 md:h-auto md:p-10 shadow-gray-400 shadow-sm rounded-lg flex flex-col gap-2 md:gap-4">
              <p className="w-[200px] text-[7px] md:text-lg md:w-[620px] font-light">
                Terima kasih Eightterior karena telah mewujudkan rumah impian saya. Design dari Eightterior sangat mengedepankan aspek fungsionalitas serta keindahan di dalamnya. Keren banget!
              </p>
              <div className="flex flex-col">
                <p className="text-primary-500 font-semibold md:text-lg text-[8px]">Ibu Andira</p>
                <p className="md:text-lg text-[7px]">Project Re-Design Kitchen</p>
              </div>
            </div>
            <div className="bg-white w-full p-4 h-24 md:h-auto md:p-10 shadow-gray-400 shadow-sm rounded-lg flex flex-col gap-2 md:gap-4">
              <p className="w-[200px] text-[7px] md:text-lg md:w-[620px] font-light">
                Eightterior telah membantu Hotel GAIA untuk mewujudkan konsep hotel bergaya industrial dengan memperhatikan green space pada design nya.
              </p>
              <div className="flex flex-col">
                <p className="text-primary-500 font-semibold md:text-lg text-[8px]">Hotel GAIA</p>
                <p className="md:text-lg text-[7px]">Project Industrial Style Hotel</p>
              </div>
            </div>
            <div className="bg-white w-full p-4 h-24 md:h-auto md:p-10 shadow-gray-400 shadow-sm rounded-lg flex flex-col gap-2 md:gap-4">
              <p className="w-[200px] text-[7px] md:text-lg md:w-[620px] font-light">
                Terima kasih Eightterior karena telah membantu perusahaan kami untuk mempunyai kantor yang memiliki gaya simpel namun tetap compact dalam fungsionalitasnya.
              </p>
              <div className="flex flex-col">
                <p className="text-primary-500 font-semibold md:text-lg text-[8px]">PT. Pundi Mitra Mandiri</p>
