          ...
          >
            ...
            <div className="relative flex flex-col justify-center h-full md:mx-52 text-white gap-1 md:gap-3 mx-16">
              ...
              <Link to={`/projects/hotel`}>
                <button className="relative text-white border md:border-2 w-28 md:w-56 h-10 md:h-16 mt-4 md:mt-6 rounded-xl text-[10px] md:text-sm hover:bg-white hover:text-primary-500 hover:font-bold">
                  LEARN MORE
                </button>
              </Link>
            </div>
