  ...
  return (
    <>
      ...
      <section className="w-full my-12 md:my-20 px-4 md:px-0">
        <div className="max-w-screen-xl bg-[#F2F2F2] flex flex-col justify-center items-center mx-auto gap-8 p-6 md:p-12 rounded-xl mb-6 md:mb-10">
          <img
        ...
        <div className="max-w-screen-xl bg-[#F2F2F2] flex flex-col justify-center items-center mx-auto gap-8 p-6 md:p-12 rounded-xl">
          <img
