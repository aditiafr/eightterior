    ...
    <>
      <section className="max-w-screen-lg flex flex-col justify-center items-center mx-auto bg-white mt-24 md:mt-32 mb-10 gap-10">
        ...
        <div className="flex flex-col justify-center items-center gap-10">
          ...
          />
          <p className="text-lg md:text-2xl md:leading-relaxed leading-relaxed px-4 md:px-0 text-justify font-light">
        ...
        <div className="flex flex-col md:flex-row px-4 md:flex-0 items-center justify-between gap-10 md:gap-20 w-full">
          <img
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between-reverse gap-10 md:gap-20 w-full px-4 md:px-0">
          <div className="flex flex-col gap-4 md:gap-6 w-full">
            <h1 className="text-3xl md:text-5xl text-primary-500 font-bold">
              Simple Pantry
            </h1>
